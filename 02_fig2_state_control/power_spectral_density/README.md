...
Example input data are provided in `git_folder/sample_PSD_data.mat`. The expected output is a PSD plot showing comparable power spectra between the pre-stimulation and stimulation windows in this control dataset. Before running the script, please keep the `chronux` toolbox folder in this directory. The script was tested in MATLAB R2022b.
