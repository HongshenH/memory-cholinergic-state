...
Example input data are provided in `git_folder/DATA.mat`. The expected output is a representative trajectory plot and spatial exploration heatmap; example expected results are provided in the output folder. The script was tested in MATLAB R2022b and requires the Image Processing Toolbox.
